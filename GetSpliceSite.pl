...
#Author: GUO Weilong, 2010, guoweilong@gmail.com
#Description:
#     Input file: Standard refFlat file added with two columns in the front, format:
#           79.7544   ADSL  NM_000026   chr22 +     39072449    39092521    39072508    39092472    13    39072449,39075781,39079022,39080197,39084813,39085209,39086351,39087222,39087437,39088930,39090225,39090829,39092385,   39072661,39075985,39079067,39080277,39084985,39085256,39086442,39087292,39087585,39089021,39090315,39091006,39092521,
#     Output file:
...
print <<END_USAGE;
      Usage:
            GetSplice.pl -f  AlternativeRef.txt -E ExonToIntron.txt -I IntronToExon.txt -l 100
            -f    input file, similar with refFlat format
            [-EI] BED file to be output, ExonToIntron / IntronToExon
